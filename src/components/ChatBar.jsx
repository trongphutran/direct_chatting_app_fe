...
function ChatBar({sendMessage}){
    ...
    return (
        ...
        <form>
            <div className="flex w-3xl p-3 border-t chat-bar rounded-xl m-4 bottom-0">
                <input 
                    className="placeholder-green-300 bg-gray-500 rounded-xl w-full p-2" 
                ...
                <button type="submit" className="w-10" id ="send-button" onClick={(e) => handleSendMessage(e, message)}>
                    <svg viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#7bf138">
